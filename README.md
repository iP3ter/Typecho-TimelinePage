...
1. 将插件目录命名为 `TimelinePage`。
2. 上传到 `usr/plugins/TimelinePage/`。
3. 在 Typecho 后台启用插件。
...
```text
[timeline]
2023-04-29|更新 [Mirages](https://get233.com/archives/mirages-intro.html)；搬迁博客到 HK Server；配图：![Server](/server.webp)
[/timeline]
```
